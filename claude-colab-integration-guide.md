...
├── demos/                          # 集中管理的演示项目
│   ├── quick-ai-demo.ipynb        # 简单AI演示
│   ├── data-visualization.ipynb    # 数据可视化展示
│   ├── ml-algorithms.ipynb        # 机器学习算法集合
│   └── tools-showcase.ipynb       # 工具集合演示
│
...
│   ├── claude_colab_sync.py       # 同步工具
│   └── github_integration.py      # GitHub集成工具
│
├── docs/                          # 文档
│   ├── best-practices.md
│   ├── troubleshooting.md
